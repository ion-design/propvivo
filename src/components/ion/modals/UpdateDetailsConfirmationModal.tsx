...
type PropvivoModalContainerProps = {
    children?: React.ReactNode;
};

function UpdateDetailsConfirmationModal({ children }: PropvivoModalContainerProps) {
...
export default UpdateDetailsConfirmationModal;
